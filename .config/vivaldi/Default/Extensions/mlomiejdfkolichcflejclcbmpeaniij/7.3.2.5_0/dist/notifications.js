...
const msg = require('./utils/msg')('notifications'),
...
const Notifications = function (win, doc) {
	...
	const createNotificationHeader = function () {
		const logoImage = chrome.extension.getURL('app/images/popup/logo.png');
	...
	const _initialize = function () {
		onMessage.addListener(function (request, sender, sendResponse) {
			const alertMessages = ['showUpgradeAlert', 'showUpdateAlert', 'showCMPMessage', 'showBrowseWindow'],
			      name = request.name,
			      msg = request.message;
